...
print_usage()
{
  ...
  echo "--seed		            Seed number for shuffling before distributing the data set, and to select train/validation partition (default: $default_shuffle_seed)"
